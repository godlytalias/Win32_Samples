...
namespace PropertiesVerb
{
    ...
    std::wstring FilePropertySheetManager::PropertySheetType() const
    {
        return L"Not Impl";
    }
    ...
    {
        _valueSet[L"PropertySheet Type"] = PropertySheetType();
        PopulateFileName();
        PopulateFileType();
        PopulateFileSize();
        PopulateCreatedDate();
    ...
    void FilePropertySheetManager::GetDisplayOrder(std::vector<std::wstring>& order) const
    {
        order = {
